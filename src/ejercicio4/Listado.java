...
public class Listado {
	...
	public void mostrarDatos(Persona arrayPersona[]) {
		for(int i=0;i<arrayPersona.length;i++) {
			...
			if(arrayPersona[i].getEdad()<18) System.out.println(arrayPersona[i].getNombre()+" es menor de edad.");
			else System.out.println(arrayPersona[i].getNombre()+" es mayor de edad.");
		}
	}
